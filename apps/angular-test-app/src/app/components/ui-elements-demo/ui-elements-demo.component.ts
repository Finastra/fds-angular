...
@Component({
    ...
    standalone: true,
    imports: [MatBadgeModule, MatButtonModule, MatIconModule, RouterLink, MatButtonToggleModule, MatCardModule, MatMenuModule, MatChipsModule, MatTabsModule, MatSlideToggleModule, MatFormFieldModule, MatInputModule, FormsModule, ReactiveFormsModule, NgIf, MatSelectModule, MatOptionModule, MatExpansionModule]
})
