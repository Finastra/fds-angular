...
@Component({
    ...
    standalone: true,
    imports: [MatChipsModule, NgFor, NgIf, MatIconModule, MatTooltipModule, MatFormFieldModule, MatInputModule, FormsModule, MatAutocompleteModule, ReactiveFormsModule, MatOptionModule, MatCheckboxModule, NgTemplateOutlet, NgClass, AsyncPipe, SlicePipe, HighlightPipe]
})
